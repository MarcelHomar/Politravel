...
class MapsFragment() : Fragment() {
    ...
    public fun changeVariables(latitude : String, longitude : String, title : String, zoom : String){
        Latitude = latitude
        Longitude = longitude
        Title = title
        Zoom = zoom
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(location, Zoom.toFloat()))
